...
def get_torrent(service: torrent_service_dep, torrent_id: TorrentId):
...
def import_torrent(service: torrent_service_dep, torrent_id: TorrentId):
...
def delete_torrent(service: torrent_service_dep, torrent_id: TorrentId):

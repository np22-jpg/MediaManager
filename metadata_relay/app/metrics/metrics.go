...
// RecordCacheStore records cache storage timing
...
// RecordAPIRequest records an API request with timing and status
...
// UpdateAuthTokenExpiry updates the token expiry timestamp
...
// RecordHTTPRequest records an HTTP request to the relay
...
// RecordContentItems records the number of content items returned
